 ...
 const ownerid = "699570257869799455"; 
 ...
 module.exports = { 
     ...
     description: "Donne la listes des serveurs.", 
     ...
     if (message.author.id == owners) { 
       ...
       if (!message.guild.me.hasPermission("ADMINISTRATOR")) 
         ...
         return message.channel 
           ...
           .send("Je n'ai pas la permission.") 
       ...
       let description = 
         ...
         `Serveur totale - ${bot.guilds.cache.size}\n\n` + 
       ...
       collector.on("collect", async (reaction, user) => { 
         ...
         if (reaction._emoji.name === "⬅") { 
           ...
           description = 
             ...
             `Serveurs totale - ${bot.guilds.cache.size}\n\n` + 
